...
//		TestImage contextImage = new TestImageImpl("src/main/resources/tests/test_2/test2_CI.png", new Point(0,0), 0, 0);
		TestImage contextImage = new TestImageImpl(PropertiesHandler.properties.getProperty(TTProperties.TESTCASE_DIRECTORY.toString()) + "/testTmpContextImage.png", new Point(0,0), 0, 0);
...
//		TestImage targetImage = new TestImageImpl("src/main/resources/tests/test_2/3-part.png", new Point(1091,298), 75, 24);
		TestImage targetImage = new TestImageImpl(PropertiesHandler.properties.getProperty(TTProperties.TESTCASE_DIRECTORY.toString())+"/testTmpTarget.png", new Point(1091,298), 75, 24);
