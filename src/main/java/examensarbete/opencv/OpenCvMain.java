...
//		TestImage[] testImages = {contextImage, targetImage};
		...
		TestImage contextImage = new TestImageImpl("D:\\WORKSPACE\\TMP_TESTCASES\\SWECLOCKERS\\GoToForum\\images\\RobertTestar\\ScreenshotFull.png", new Point(0,0), 0, 0);
		TestImage targetImage = new TestImageImpl("D:\\WORKSPACE\\TMP_TESTCASES\\SWECLOCKERS\\GoToForum\\images\\RobertTestar\\BrowserAsTarget.png", new Point(619,386), 75, 24);
