...
//		TestImage contextImage = new TestImageImpl("src/main/resources/tests/test_2/2-whole.png", new Point(0,0), 0, 0);
		TestImage contextImage = new TestImageImpl("src/main/resources/tests/test_2/2-whole-changed.png", new Point(0,0), 2560, 1308);
		TestImage targetImage = new TestImageImpl("src/main/resources/tests/test_2/2-part.png", new Point(850,757), 80, 51);
