...
public class GoogleCloudVision {
	...
	public void detectWebDetections(String filePath, PrintStream out) throws Exception, IOException {
		List<AnnotateImageRequest> requests = new ArrayList<>();
	   ...
	   * @throws IOException on Input/Output errors.
	   */
	  public void detectLogos(String filePath, PrintStream out) throws Exception, IOException {
	    List<AnnotateImageRequest> requests = new ArrayList<>();
	   ...
	   * @throws IOException on Input/Output errors.
	   */
	  public void detectProperties(String filePath, PrintStream out) throws Exception,
	      IOException {
	    List<AnnotateImageRequest> requests = new ArrayList<>();
...
//	// [END vision_detect_document]
	   ...
	   * @throws IOException on Input/Output errors.
	   */
	  public void detectCropHints(String filePath, PrintStream out) throws Exception,
	      IOException {
	    List<AnnotateImageRequest> requests = new ArrayList<>();
	   ...
	   * @throws IOException on Input/Output errors.
	   */
	  public void detectWebEntities(String filePath, PrintStream out) throws Exception,
	      IOException {
